        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold">BookOn</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              The leading platform for booking children's activities, connecting parents with trusted venues and exciting experiences.
            </p>
