-- Simple Migration Script - Just create Phase 5 tables and sample data
...
-- Add missing fields to bookings table (if it exists)
DO $$ 
BEGIN
...
-- Verify the Phase 5 tables were created
